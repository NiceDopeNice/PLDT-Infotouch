    ...
    <transition name="fade" v-if="show">
        <section>
          ...
          <div class="start_container" v-if="!setup">
            <div class="fits_me">NEED HELP?</div>
            <div class="play_cont">
            ...
            <div class="choose_plan">Check your service and network coverage in your location and get help on account-related inquiries.</div>
          </div>
          
          <div class="setup_container" v-else>
            <div class="setup_title">
              <h1>Step 1: Set the location of this Infotouch</h1>
            </div>
