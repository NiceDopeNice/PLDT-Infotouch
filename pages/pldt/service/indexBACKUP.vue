    ...
    <div class="product_page">
        ...
        <img class="product_logo" src="img/pldt.png" alt="" />
          ...
          <transition name="fade">
            <section class="service_repair_container" v-if="show">
                <div class="service_repair_menu">
                  <nuxt-link to="service/new">
                    <img src="img/customer-new.png" alt="">
                    <p>I'm a new customer</p>
                  </nuxt-link>
                </div>
                <div class="service_repair_menu">
                  <nuxt-link to="service/existing">
                    <img src="img/customer-existing.png" alt="">
