            ...
            <div class="sscs_holder" v-if="show">
                ...
                <section class="sscs_container">
                    <div class="sscs_main">
                        ...
                        <div style="width: 100%; height: 530px;" class="map_container" v-if="SSCSListPerDistrict">
                            <gmap-map
                                ref="map"
                            ...
                            >
                                <gmap-marker
                                    ...
                                    :draggable="false"
                                    :mapTypeControl="true"
                                    :icon="'img/smart_marker_icon.png'"
...
export default {
  ...
  mounted() {
      ...
      this.$axios.$get('getAllSSCS?ssc_group=smart').then( res => {
        if(res){
            this.show = true;
